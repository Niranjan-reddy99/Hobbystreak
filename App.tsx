// App.tsx — BASE CODE + LIKES & COMMENTS MERGED (complete) - PART 1
import './App.css';
...
// =================== PART 2: corrected fetchHobbiesAndPosts ===================
  // --- INITIALIZATION ---
  useEffect(() => {
    const initApp = async () => {
        if (!supabase) {
...
  // FETCH HOBBIES & POSTS (CORRECTED: includes author lookup, comments, likes)
...
    // 3. Fetch all authors at once (profiles)
...
    // 4. Fetch comments (simple)
    const { data: commentsData } = await supabase.from('comments').select('*');

    // 5. Fetch likes for current user
...
    // 6. Build posts with real author names & avatars
...
      return days;
  };
// =================== PART 4: LIKES & COMMENTS + RENDER UI PARTS ===================
